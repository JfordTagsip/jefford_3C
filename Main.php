...
class Main {
    ...
    public function start() {
        do {
            ...
            echo "\nCurrent Roster Size: " . $this->employeeRoster->countEmployees() . " | Remaining Capacity: " . $this->employeeRoster->getRosterSize() . "\n";
    ...
    private function setRosterSize() {
        ...
        while (!is_numeric($size) || $size <= 0) {
            echo "Please enter a valid positive number for the roster size: ";
            $size = trim(fgets(STDIN));
        }
